...
public class Form16Controller : ControllerBase
{
    ...
    public ActionResult<Form16DataDto> GetSampleForm16Data()
    {
        var sampleData = new Form16DataDto
        {
            ...
            EmployerAddress = "123 Business Park, MG Road, Sample City",
    ...
    private Form16Data MapToModel(Form16DataDto dto)
    {
        return new Form16Data
        {
            ...
            TAN = dto.TAN,
            // Additional employer details
            EmployerCategory = dto.EmployerCategory,
            EmployerPinCode = dto.EmployerPinCode,
            EmployerAddress = dto.EmployerAddress,
            EmployerCountry = dto.EmployerCountry,
